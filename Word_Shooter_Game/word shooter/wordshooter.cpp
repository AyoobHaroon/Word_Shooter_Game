...
void DisplayFunction() {
	...
	//first row
	int r1 = 0, r2 = 0;
        int random = GetRandInRange(1, 26);
	
	DrawAlphabet((alphabets)random, r1, 570, awidth, aheight);
	r1 += 60;
        random = GetRandInRange(1, 26);
        DrawAlphabet((alphabets)random, r1, 570, awidth, aheight);
	r1 += 60;
        random = GetRandInRange(1, 26);
        DrawAlphabet((alphabets)random, r1, 570, awidth, aheight);
	...
	r1 += 60;
        ...
        DrawAlphabet((alphabets)random, r2, 510, awidth, aheight);
	r2 += 60;
	random = GetRandInRange(1, 26);
	DrawAlphabet((alphabets)random, r2, 510, awidth, aheight);
	r2 += 60;
	...
	random = GetRandInRange(1, 26);
        ...
        //shooter
        DrawAlphabet((alphabets)random, 460, 10, awidth, aheight);
...
void Timer(int m) {
	...
	glutPostRedisplay();
	glutTimerFunc(1000000.0/FPS, Timer, 0);
}
